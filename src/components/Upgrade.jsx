...
export default function Upgrade() {
  ...
  return (
    <section className="upgrade relative">
      <LetterGlitch
        glitchSpeed={50}
        centerVignette={true}
        outerVignette={false}
      ...
      <div className="relative z-10 py-20 flex flex-col gap-14 items-center">
        <div className="container1 flex flex-col gap-2">
          ...
          <p className="font-helvetica text-base font-light text-[#fde9e9] text-center">
        ...
        <div className="twoCard container1 flex gap-8 w-full">
          <div className="firstCard flex flex-col w-1/2 bg-[#012749] rounded">
            ...
            <div className="desc p-[30px] flex flex-col justify-between h-full gap-4">
              <h3 className="font-helvetica text-[32px] font-normal text-white">
                {t("upgrade.componentReplacement")}
              </h3>
              <p className="font-helvetica text-2xl font-normal text-[#019ee2]">
                {t("upgrade.desc1")}
              </p>
              <ul className="font-helvetica text-xl font-light text-[#fbfeff]">
          ...
          <div className="secondCard flex flex-col w-1/2 bg-[#012749] rounded">
            <div className="img h-[345px]">
              <img
                src={upgrade1}
                alt="upgrade"
