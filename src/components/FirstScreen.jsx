    ...
    <>
      ...
      {details && details.length > 0 ? (
        <section className="first-screen flex sm:hidden bg-no-repeat relative z-10  px-3 lg:px-32 pt-[88px] lg:pt-[152px]">
          <div className="w-full h-[320px] absolute z-[4]">
            <img
              src={details[0].image}
              alt="first-screen"
          ...
          <div className="gradient-overlay absolute top-0 left-0 w-[60%] h-[320px] mt-[88px] lg:mt-[152px] z-5"></div>
          <div className="first-screen-content flex flex-col items-start justify-start gap-6 lg:gap-9 z-20 py-20 pt-[60px] w-[70%]">
            <h1 className="font-PlayfairDisplay text-[#FFFEFE] text-xl lg:text-5xl font-bold leading-7 lg:leading-18">
              {getLocalizedField(details[0], "h_text", lang)}
            </h1>
