...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="aboutUs bg-[#E7F1FC] flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-16 py-5 lg:py-20 px-10 lg:px-20 xl:px-[155px]"
    >
      ...
      <div className="flex flex-col sm:flex-row w-full gap-8 lg:gap-16">
        ...
        <div className="textCards w-full sm:w-[50%] flex flex-col items-start gap-3 lg:gap-8 xl:gap-14">
          <div className="text flex flex-col items-start justify-center gap-6">
            ...
            <p className="font-helvetica text-xs sm:text-xs lg:text-base font-light">
              {details && details.length > 0
