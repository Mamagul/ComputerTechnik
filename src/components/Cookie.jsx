  ...
  return (
    <div className="w-full bg-white text-[#302727] px-3 py-2 lg:py-4 lg:px-10  z-50 flex flex-col sm:flex-row justify-between items-end sm:items-center gap-2 lg:gap-32">
      ...
      <div className="flex gap-2 lg:gap-8">
        ...
        <button
          onClick={handleClose}
          className="flex items-center justify-center bg-[#e7f1fc] text-[#019ee2] border-[#019ee2] border-[1px] px-1 py-1 lg:px-2 lg:py-2 rounded-[2px] lg:rounded text-[10px] lg:text-base"
        >
